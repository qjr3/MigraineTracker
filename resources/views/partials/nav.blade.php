            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-left">
                    ...
                    <li class="dropdown">
                        ...
                        <a href="#" class="dropdown-toggle {{ Request::is('journal') ? 'active' : null }}"
                           data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Journals<span
                                    class="caret"></span></a>
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle {{ Request::is('trigger') ? 'active' : null }}"
                           data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Triggers<span
                                    class="caret"></span></a>
                        <ul class="dropdown-menu">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle {{ Request::is('medicine') ? 'active' : null }}"
                           data-toggle="dropdown" role="button" aria-haspopup="true"
                           aria-expanded="false">Medication<span class="caret"></span></a>
                        <ul class="dropdown-menu">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle {{ Request::is('note') ? 'active' : null }}"
                    ...
                    <li>
                        {!! link_to_action('ReportController@create', 'Generate Report') !!}
                    </li>
                </ul>
