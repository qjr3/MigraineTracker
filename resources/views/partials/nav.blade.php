            ...
            @if(Auth::check())
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-left">
                        ...
                        <li {{ Request::is('journal*') ? 'class=active dropdown' : 'class=dropdown' }}>

                            <a href="#" class="dropdown-toggle"
                               data-toggle="dropdown" role="button" aria-haspopup="true"
                               aria-expanded="false">Journals<span
                                        class="caret"></span></a>
                        ...
                        <li {{ Request::is('trigger*') ? 'class=active dropdown' : 'class=dropdown' }}>
                            <a href="#" class="dropdown-toggle"
                               data-toggle="dropdown" role="button" aria-haspopup="true"
                               aria-expanded="false">Triggers<span
                                        class="caret"></span></a>
                            <ul class="dropdown-menu">
                        ...
                        <li {{ Request::is('medicine*') ? 'class=active dropdown' : 'class=dropdown' }}>
                            <a href="#" class="dropdown-toggle"
                               data-toggle="dropdown" role="button" aria-haspopup="true"
                        ...
                        <li {{ Request::is('note*') ? 'class=active dropdown' : 'class=dropdown' }}>
                            <a href="#" class="dropdown-toggle"
                               data-toggle="dropdown" role="button" aria-haspopup="true"
                               aria-expanded="false">Notes<span
                                        class="caret"></span></a>
                            <ul class="dropdown-menu">
