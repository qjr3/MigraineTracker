...
<div class='col-xs-offset-1 col-xs-10 col-xs-offset-1'>
                        ...
                        <div class="row">
                            ...
                            <div class="panel panel-info">
                                ...
                                <div class='row'>
                                    <div class='col-xs-offset-1 col-xs-5 text-right'>{!! Form::submit('Save Changes', ['class' => 'btn btn-success']) !!}</div>
                                    <div class='col-xs-5 text-left'>{!! link_to_action('UserController@show', 'Cancel', $user->id, ['class' => 'btn btn-danger', 'role' => 'button']) !!}</div>
                                </div><br />
                            </div>
