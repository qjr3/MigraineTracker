...
@section('content')
                ...
                {!! Form::model($journal, ['action' => ['JournalController@update', $journal->id], 'method' => 'PATCH']) !!}
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6">
                            <div class="form-group row">
                                <div class='col-xs-6'>{!! Form::label('has_vomitted', 'Vomitted?', ['class' => 'form-label']) !!}</div>
                                <div class='col-xs-6'>{!! Form::select('has_vomitted',  [ '' => '', 'true' => 'Yes', 'false' => 'No'], null, ['class' => 'form-control']) !!}</div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class='col-xs-6'>
                            <div class="form-group row">
                                <div class='col-xs-6'>{!! Form::label('has_light_sensativity', 'Light Sensativity', ['class' => 'form-label']) !!}</div>
                                <div class='col-xs-6'>{!! Form::select('has_light_sensativity',  [ '' => '', 'true' => 'Yes', 'false' => 'No'], null, ['class' => 'form-control']) !!}</div>
                            </div>
                            <div class="form-group row">
                                <div class='col-xs-6'>{!! Form::label('has_sound_sensativity', 'Sound Sensativity', ['class' => 'form-label']) !!}</div>
                                <div class='col-xs-6'>{!! Form::select('has_sound_sensativity',  [ '' => '', 'true' => 'Yes', 'false' => 'No'], null, ['class' => 'form-control']) !!}</div>
                            </div>
                            <div class="form-group row">
