...
class CreateCommonTriggersTable extends Migration
{
    ...
    public function up()
    {
        ...
        $table = DB::table('common_triggers')->insert([
            ...
            ['name' => 'Sour Creame', 'description' => 'Ate sour cream.'],
            ['name' => 'Nuts, Nut-butters', 'description' => 'Consuming nuts or nut bearing foods.'],
            ['name' => 'Sourdough break', 'description' => 'Contains active bateria some are sensative.'],
            ...
            ['name' => 'Menstration', 'description' => 'Loss of vital minerals and vitamins can cause migraines.'],
        ]);
    }
